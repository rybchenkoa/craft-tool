...
int RemoteDevice::calculate_new_delta(Coords& delta, const Coords& pos)
{
...
Coords RemoteDevice::to_hard(const Coords& pos) const
{
	Coords result = pos;
...
void RemoteDevice::set_spindle_params(int marksCount, int marksPin, int marksFrequency, int filterSize)
{
	...
	packet->frequency = marksFrequency;
...
//============================================================
double RemoteDevice::get_max_velocity(int coord)
{
	return velocity[coord];
}

//============================================================
double RemoteDevice::get_max_acceleration(int coord)
{
...
void RemoteDevice::init()
{
	...
	int spindleFilterSize = 5; // размер фильтра для датчика
