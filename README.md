...
- Управление скоростью с помощью напряжения на пине (не выведено в интерфейс)
- ШИМ лазера
- Синхронизация со шпинделем (пока не готово)
...
- G32 - синхронизация со шпинделем (пока не готово)
